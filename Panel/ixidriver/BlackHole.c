...
#ifndef kDriver_Name
#define                             kDriver_Name                        "IXIMega Device"
#endif

#ifndef kPlugIn_BundleID
#define                             kPlugIn_BundleID                    "com.ixi.ixiMega.Driver"
#endif

#ifndef kPlugIn_Icon
#define                             kPlugIn_Icon                        "icon.icns"
#endif

#ifndef kHas_Driver_Name_Format//是否添加后缀名
#define                             kHas_Driver_Name_Format             true
#endif

#if kHas_Driver_Name_Format
//#define                             kDriver_Name_Format                 "%ich"
#define                             kDriver_Name_Format                 ""
...
static UInt32                       kClockSource_NumberItems            = 1;
...
#ifndef kSampleRates
#define                             kSampleRates       44100, 48000, 88200, 96000, 176400, 192000
#endif
...
{
	if (volume <= powf(10.0f, kVolume_MinDB / 1000.0f))
		return kVolume_MinDB;
	else
		return 1000.0f * log10f(volume);
}
...
static Float32 volume_from_decibel(Float32 decibel)
{
	if (decibel <= kVolume_MinDB)
		...
		return powf(10.0f, decibel / 1000.0f);
}
